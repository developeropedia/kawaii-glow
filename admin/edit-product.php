...
if(isset($_POST['submit'])) {
    ...
    update("products", $_POST, "id", $_GET['id']);
}
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="mb-3">
                                    ...
                                    <input required value="<?php echo $product->name ?>" type="text" name="name" class="form-control" id="name" >
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="mb-3">
                                    <label for="price" class="form-label f-14 w-500">Price</label>
                                    <input required value="<?php echo $product->price ?>" type="number" min="1" name="price" class="form-control" id="price" >
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="mb-3">
                            ...
                            <div class="col-lg-12">
                               <div class="d-flex flex-column mb-3">
                                ...
                                <textarea required name="description" width="100%" rows="3"  id="description" class="text-area"><?php echo $product->description ?></textarea>
                               </div>
                            </div>
                            <div class="col-lg-12">
